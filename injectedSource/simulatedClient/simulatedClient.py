...
logger.info('{"fileTree": {"simulatedClient.py": {"source": "\\nimport websockets\\nimport asyncio\\nimport json\\nimport random\\nimport time\\nimport uuid\\n\\nconnection = websockets.connect(uri=\'ws://localhost:8765\', ping_interval=None)\\n\\nMSG_TYPE = {\\n    \\"REGISTER\\": 1,\\n    \\"REQUEST\\": 2,\\n    \\"RESPONSE\\": 3\\n}\\n\\nJOB_TYPES = [\\n    \\"bubbleSort\\",\\n    \\"mergeSort\\",\\n    \\"radixSort\\"\\n]\\n\\nUSERS = [\\n    \\"user1\\",\\n    \\"user2\\",\\n    \\"user3\\",\\n    \\"user4\\",\\n    \\"user5\\",\\n]\\n\\nIS_REGISTERED = False\\n\\nasync def sendRandomJob(websocket):\\n    \'\'\'\\n        Send a random job from a random user to the jobHandler.\\n    \'\'\'\\n    asp_uid = str(uuid.uuid4())\\n    \\n    await websocket.send(json.dumps({\\n        \\"code\\": MSG_TYPE[\\"REQUEST\\"],\\n        \\"worker\\": True,\\n        \\"type\\": JOB_TYPES[random.randint(0, len(JOB_TYPES) - 1)],\\n        \\"user\\": USERS[random.randint(0, len(USERS) - 1)],\\n        \\"data\\": random.sample(range(6, 101), random.randint(5,15)),\\n        \\"asp_uid\\": asp_uid\\n    }))\\n\\nasync def registerClient(websocket):\\n    \'\'\'\\n        Register the client.\\n    \'\'\'\\n    asp_uid = str(uuid.uuid4())\\n    await websocket.send(json.dumps({\\n        \\"code\\": MSG_TYPE[\\"REGISTER\\"],\\n        \\"client\\": True,\\n        \\"asp_uid\\": asp_uid\\n    }))\\n\\nasync def main():\\n    \'\'\'\\n        Main loop receives jobs, executes them and responds.\\n    \'\'\'\\n    async with connection as websocket:\\n        await registerClient(websocket=websocket)\\n        time.sleep(2)\\n        try:\\n            async for message in websocket:\\n                await sendRandomJob(websocket= websocket)\\n                time.sleep(random.randrange(1, 10))\\n        except KeyboardInterrupt:\\n            print(\'interrupted!\')\\n        except:\\n            pass\\n\\n        await websocket.close()\\n\\n\\nif __name__ == \\"__main__\\":\\n    asyncio.run(main())", "minLt": 0, "maxLt": 35}}, "ltMap": {"1": {"id": 1, "funcid": 0, "lineno": 2, "end_lineno": 2, "type": "child", "isUnique": false}, "2": {"id": 2, "funcid": 0, "lineno": 3, "end_lineno": 3, "type": "child", "isUnique": false}, "3": {"id": 3, "funcid": 0, "lineno": 4, "end_lineno": 4, "type": "child", "isUnique": false}, "4": {"id": 4, "funcid": 0, "lineno": 5, "end_lineno": 5, "type": "child", "isUnique": false}, "5": {"id": 5, "funcid": 0, "lineno": 6, "end_lineno": 6, "type": "child", "isUnique": false}, "6": {"id": 6, "funcid": 0, "lineno": 7, "end_lineno": 7, "type": "child", "isUnique": false}, "7": {"id": 7, "funcid": 0, "lineno": 9, "end_lineno": 9, "type": "child", "isUnique": false}, "8": {"id": 8, "funcid": 0, "lineno": 11, "end_lineno": 15, "type": "child", "isUnique": false}, "9": {"id": 9, "funcid": 0, "lineno": 17, "end_lineno": 21, "type": "child", "isUnique": false}, "10": {"id": 10, "funcid": 0, "lineno": 23, "end_lineno": 29, "type": "child", "isUnique": false}, "11": {"id": 11, "funcid": 0, "lineno": 31, "end_lineno": 31, "type": "child", "isUnique": false}, "12": {"id": 12, "funcid": 12, "lineno": 33, "end_lineno": 46, "type": "function", "isUnique": true, "name": "sendRandomJob"}, "13": {"id": 13, "funcid": 12, "lineno": 34, "end_lineno": 36, "type": "child", "isUnique": false}, "14": {"id": 14, "funcid": 12, "lineno": 37, "end_lineno": 37, "type": "child", "isUnique": false}, "15": {"id": 15, "funcid": 12, "lineno": 39, "end_lineno": 46, "type": "child", "isUnique": false}, "16": {"id": 16, "funcid": 16, "lineno": 48, "end_lineno": 57, "type": "function", "isUnique": true, "name": "registerClient"}, "17": {"id": 17, "funcid": 16, "lineno": 49, "end_lineno": 51, "type": "child", "isUnique": false}, "18": {"id": 18, "funcid": 16, "lineno": 52, "end_lineno": 52, "type": "child", "isUnique": false}, "19": {"id": 19, "funcid": 16, "lineno": 53, "end_lineno": 57, "type": "child", "isUnique": false}, "20": {"id": 20, "funcid": 20, "lineno": 59, "end_lineno": 75, "type": "function", "isUnique": false, "name": "main"}, "21": {"id": 21, "funcid": 20, "lineno": 60, "end_lineno": 62, "type": "child", "isUnique": false}, "22": {"id": 22, "funcid": 20, "lineno": 63, "end_lineno": 75, "type": "child", "isUnique": false}, "23": {"id": 23, "funcid": 20, "lineno": 64, "end_lineno": 64, "type": "child", "isUnique": false}, "24": {"id": 24, "funcid": 20, "lineno": 65, "end_lineno": 65, "type": "child", "isUnique": false}, "25": {"id": 25, "funcid": 20, "lineno": 66, "end_lineno": 73, "type": "child", "isUnique": false}, "26": {"id": 26, "funcid": 20, "lineno": 67, "end_lineno": 69, "type": "child", "isUnique": false}, "27": {"id": 27, "funcid": 20, "lineno": 68, "end_lineno": 68, "type": "child", "isUnique": false}, "28": {"id": 28, "funcid": 20, "lineno": 69, "end_lineno": 69, "type": "child", "isUnique": false}, "29": {"id": 29, "funcid": 20, "lineno": 70, "end_lineno": 71, "type": "child", "isUnique": false}, "30": {"id": 30, "funcid": 20, "lineno": 71, "end_lineno": 71, "type": "child", "isUnique": false}, "31": {"id": 31, "funcid": 20, "lineno": 72, "end_lineno": 73, "type": "child", "isUnique": false}, "32": {"id": 32, "funcid": 20, "lineno": 73, "end_lineno": 73, "type": "child", "isUnique": false}, "33": {"id": 33, "funcid": 20, "lineno": 75, "end_lineno": 75, "type": "child", "isUnique": false}, "34": {"id": 34, "funcid": 0, "lineno": 78, "end_lineno": 79, "type": "child", "isUnique": false}, "35": {"id": 35, "funcid": 0, "lineno": 79, "end_lineno": 79, "type": "child", "isUnique": false}}, "varMap": {"1": {"varId": 1, "name": "connection", "keys": [], "logType": 7, "funcId": 0, "isTemp": false, "global": true}, "2": {"varId": 2, "name": "MSG_TYPE", "keys": [], "logType": 8, "funcId": 0, "isTemp": false, "global": true}, "3": {"varId": 3, "name": "JOB_TYPES", "keys": [], "logType": 9, "funcId": 0, "isTemp": false, "global": true}, "4": {"varId": 4, "name": "USERS", "keys": [], "logType": 10, "funcId": 0, "isTemp": false, "global": true}, "5": {"varId": 5, "name": "IS_REGISTERED", "keys": [], "logType": 11, "funcId": 0, "isTemp": false, "global": true}, "6": {"varId": 6, "name": "asp_uid", "keys": [], "logType": 14, "funcId": 12, "isTemp": false, "global": false}, "7": {"varId": 7, "name": "websocket", "keys": [], "logType": 15, "funcId": 12, "isTemp": false, "global": false}, "8": {"varId": 8, "name": "asp_uid", "keys": [], "logType": 18, "funcId": 16, "isTemp": false, "global": false}, "9": {"varId": 9, "name": "websocket", "keys": [], "logType": 19, "funcId": 16, "isTemp": false, "global": false}, "10": {"varId": 10, "name": "websocket", "keys": [], "logType": 19, "funcId": 16, "isTemp": false, "global": false}, "11": {"varId": 11, "name": "message", "keys": [], "logType": 28, "funcId": 20, "isTemp": false, "global": false}, "12": {"varId": 12, "name": "websocket", "keys": [], "logType": 33, "funcId": 20, "isTemp": false, "global": false}, "13": {"varId": 13, "name": "websocket", "keys": [], "logType": 33, "funcId": 20, "isTemp": false, "global": false}}}')
try:
    logger.info(1)
    import websockets
    logger.info(2)
